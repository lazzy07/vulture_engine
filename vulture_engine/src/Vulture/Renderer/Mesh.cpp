...
namespace Vulture {
	Mesh::Mesh(void* vertices, size_t vSize, void* indices, size_t iSize) :
	...
	void Mesh::Draw(Ref<Shader> shader, glm::vec3 position, glm::vec3 rotation, glm::vec3 scale)
	{
	...
	void Mesh::SetupMesh()
	{
		...
		m_IBO.reset(IndexBuffer::Create((unsigned int *)m_Indices, m_IndicesSize/sizeof(unsigned int)));
